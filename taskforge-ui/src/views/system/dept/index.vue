  ...
  <div class="page">
    <el-form :inline="true" :model="query" class="toolbar" @submit.prevent>
      ...
      <el-form-item>
        ...
        <el-button v-hasPermi="'system:dept:add'" type="success" @click="openDialog()">新增</el-button>
      </el-form-item>
    </el-form>
    ...
    >
      ...
      <el-table-column label="操作" width="180" fixed="right">
        <template #default="{ row }">
          <el-button v-hasPermi="'system:dept:edit'" link type="primary" @click="openDialog(row)">编辑</el-button>
